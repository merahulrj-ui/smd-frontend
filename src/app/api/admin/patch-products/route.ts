...
export async function GET(req: Request) {
  try {
    ...
    // 1. Fix Patients Transfer Trolly Price and MRP
    const [res1] = await pool.query(`
      UPDATE products 
      SET price = 42000, 
          mrp = 58000, 
          short_description = 'DHPT-1150 Emergency & Recovery Hydraulic Patient Transfer Trolley with foot-operated hydraulic pump, X-ray cassette tray, oxygen cylinder holder, and safety side rails.'
    ...
    const techShort = 'Premium C-Arm compatible hydraulic operation theatre table with SS 304 construction, radio-translucent top, and 360-degree fluoroscopy access.';
